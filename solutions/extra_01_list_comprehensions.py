...
prices_over_30 = [price for price in prices if price > 30]
print(prices_over_30)
...
If a list comprehension ever feels confusing,
it's always okay to write the longer for loop instead.
'''